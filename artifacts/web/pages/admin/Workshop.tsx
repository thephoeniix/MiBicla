        ...
        <Modal open className="workshop-detail" aria-labelledby="workshop-detail-title">
          ...
          <header className="modal-header workshop-detail-header">
            <div className="workshop-detail-identity">
              ...
              <p><strong>{detailCustomer ? `${detailCustomer.firstName} ${detailCustomer.lastName}` : "Cliente registrado"}</strong><span aria-hidden="true"> · </span>{detail.order.problemDescription || "Bicicleta registrada"}</p>
            </div>
          ...
          {detailTab === "summary" && <section className="order-summary">
            <div className="order-summary-grid">
              <Card><small>Cliente</small><strong>{detailCustomer ? `${detailCustomer.firstName} ${detailCustomer.lastName}` : "Cliente registrado"}</strong></Card>
          ...
          {detailTab === "customer" && <section className="order-customer-panel">
            <Card><small>Cliente</small><h3>{detailCustomer ? `${detailCustomer.firstName} ${detailCustomer.lastName}` : "Cliente registrado"}</h3><p>{detailCustomer?.phone ?? "Teléfono no disponible en esta vista"}</p></Card>
